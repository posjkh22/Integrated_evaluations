...
@.str.5 = private unnamed_addr constant [13 x i8] c"overhead.txt\00", align 1
@.str.6 = private unnamed_addr constant [2 x i8] c"a\00", align 1
@.str.7 = private unnamed_addr constant [25 x i8] c" [target has finished!]\0A\00", align 1
...
; <label>:22:                                     ; preds = %19
  ...
  %24 = call i32 (%struct._IO_FILE*, i8*, ...) @__isoc99_fscanf(%struct._IO_FILE* %23, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.4, i32 0, i32 0), i32* %8)
  %25 = load i32, i32* %8, align 4
  %26 = load i32, i32* %6, align 4
  %27 = sext i32 %26 to i64
  %28 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* @AdjMatrix, i64 0, i64 %27
...
; <label>:43:                                     ; preds = %40
  ...
  %48 = call i32 @dijkstra(i32 %46, i32 %47)
  br label %49
...
; <label>:54:                                     ; preds = %40
  %55 = call i32 @gettimeofday(%struct.timeval* %11, %struct._NODE* null) #3
  %56 = call %struct._IO_FILE* @fopen(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.5, i32 0, i32 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.6, i32 0, i32 0))
  store %struct._IO_FILE* %56, %struct._IO_FILE** %12, align 8
  %57 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.7, i32 0, i32 0))
  %58 = getelementptr inbounds %struct.timeval, %struct.timeval* %11, i32 0, i32 0
  ...
  %64 = getelementptr inbounds %struct.timeval, %struct.timeval* %11, i32 0, i32 1
  %65 = load i64, i64* %64, align 8
  %66 = getelementptr inbounds %struct.timeval, %struct.timeval* %10, i32 0, i32 1
  %67 = load i64, i64* %66, align 8
  %68 = sub nsw i64 %65, %67
  %69 = add nsw i64 %63, %68
  %70 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.8, i32 0, i32 0), i64 %69)
  %71 = load %struct._IO_FILE*, %struct._IO_FILE** %12, align 8
  %72 = getelementptr inbounds %struct.timeval, %struct.timeval* %11, i32 0, i32 0
  %73 = load i64, i64* %72, align 8
  %74 = getelementptr inbounds %struct.timeval, %struct.timeval* %10, i32 0, i32 0
  %75 = load i64, i64* %74, align 8
  %76 = sub nsw i64 %73, %75
  %77 = mul nsw i64 %76, 1000000
  %78 = getelementptr inbounds %struct.timeval, %struct.timeval* %11, i32 0, i32 1
  %79 = load i64, i64* %78, align 8
  %80 = getelementptr inbounds %struct.timeval, %struct.timeval* %10, i32 0, i32 1
  %81 = load i64, i64* %80, align 8
  %82 = sub nsw i64 %79, %81
  %83 = add nsw i64 %77, %82
  %84 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %71, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.9, i32 0, i32 0), i64 %83)
