...
@.str.2 = private unnamed_addr constant [13 x i8] c"overhead.txt\00", align 1
...
define i32 @main(i32, i8**) #0 {
  ...
  store i8** %1, i8*** %5, align 8
  %11 = call i32 @gettimeofday(%struct.timeval* %7, %struct.timezone* null) #4
  br label %12

; <label>:12:                                     ; preds = %2
  call void @enqueue_signature(i32 720898)
  %13 = call %struct._IO_FILE* @fopen(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i32 0, i32 0))
  br label %14
...
; <label>:14:                                     ; preds = %12
  ...
  call void @sha_stream(%struct.SHA_INFO* %9, %struct._IO_FILE* %15)
  br label %16
...
; <label>:20:                                     ; preds = %17
  ...
  %21 = call %struct._IO_FILE* @fopen(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i32 0, i32 0))
  br label %22
...
; <label>:24:                                     ; preds = %22
  ...
  %25 = call i32 @gettimeofday(%struct.timeval* %8, %struct.timezone* null) #4
  br label %26

; <label>:26:                                     ; preds = %24
  call void @enqueue_signature(i32 720905)
  %27 = getelementptr inbounds %struct.timeval, %struct.timeval* %8, i32 0, i32 0
  %28 = load i64, i64* %27, align 8
  %29 = getelementptr inbounds %struct.timeval, %struct.timeval* %7, i32 0, i32 0
  %30 = load i64, i64* %29, align 8
  %31 = sub nsw i64 %28, %30
  %32 = mul nsw i64 %31, 1000000
  %33 = getelementptr inbounds %struct.timeval, %struct.timeval* %8, i32 0, i32 1
  %34 = load i64, i64* %33, align 8
  %35 = getelementptr inbounds %struct.timeval, %struct.timeval* %7, i32 0, i32 1
  %36 = load i64, i64* %35, align 8
  %37 = sub nsw i64 %34, %36
  %38 = add nsw i64 %32, %37
  %39 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.5, i32 0, i32 0), i64 %38)
  br label %40
...
; <label>:40:                                     ; preds = %26
  ...
  %42 = getelementptr inbounds %struct.timeval, %struct.timeval* %8, i32 0, i32 0
  %43 = load i64, i64* %42, align 8
  %44 = getelementptr inbounds %struct.timeval, %struct.timeval* %7, i32 0, i32 0
  %45 = load i64, i64* %44, align 8
  %46 = sub nsw i64 %43, %45
  %47 = mul nsw i64 %46, 1000000
  %48 = getelementptr inbounds %struct.timeval, %struct.timeval* %8, i32 0, i32 1
  %49 = load i64, i64* %48, align 8
  %50 = getelementptr inbounds %struct.timeval, %struct.timeval* %7, i32 0, i32 1
  %51 = load i64, i64* %50, align 8
  %52 = sub nsw i64 %49, %51
  %53 = add nsw i64 %47, %52
  %54 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %41, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.6, i32 0, i32 0), i64 %53)
  br label %55

; <label>:55:                                     ; preds = %40
  call void @enqueue_signature_with_remainder_process(i32 720907)
  ret i32 0
}
