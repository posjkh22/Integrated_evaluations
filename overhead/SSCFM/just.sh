...
./run.sh whetstone TH1 on
./run.sh whetstone TH2 on
./run.sh whetstone TH3 on
./run.sh whetstone TH4 on


elif [ $1="2" ]; then

./run.sh dhrystone TH1 on
./run.sh dhrystone TH2 on
./run.sh dhrystone TH3 on
./run.sh dhrystone TH4 on
